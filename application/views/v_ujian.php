...
<head>
<meta charset="utf-8">
<title>Ujian Running - <?php echo $this->config->item('nama_aplikasi')." ".$this->config->item('versi'); ?></title>
...
<nav class="navbar navbar-findcond navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <span class="logo pull-left" style="margin:2px; margin-right:10px" ><img src="<?php echo base_url(); ?>___/img/logotb-256.png" width="50" /></span>
        ...
        <form role="form" name="_form" method="post" id="_form">
            <div class="panel panel-default">
                ...
                <div class="panel-footer text-center">
                    ...
                    <a class="action next btn btn-info" rel="2" onclick="return next();"><i class="glyphicon glyphicon-chevron-right"></i> Simpan dan Lanjut</a>

                    <a class="ragu_ragu btn btn-warning" rel="1" onclick="return tidak_jawab();">Ragu-ragu</a>
					
					<a class="action btn btn-success" data-toggle="modal" data-target="#essayPanel" >ESSAY</a>
...
<div id="essayPanel" class="modal fade " role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Soal Essay</h4>
      </div>
      ...
      <div class="modal-footer">
      	<div>
        	<span class="pull-left" style="color:red">Silahkan kerjakan soal Essay diatas di lembar jawaban (Kertas) yang telah disediakan.</span>
        </div>
